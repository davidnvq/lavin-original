...
from lavin.utils.misc import get_rank
...
def parse_args():
    ...
    parser.add_argument('--temperature', type=float, default=5., metavar='LENGTH', help='the temperature of router')
...
lavin = load(ckpt_dir=args.ckpt_dir,
