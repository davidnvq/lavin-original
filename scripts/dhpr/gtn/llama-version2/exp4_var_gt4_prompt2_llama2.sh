...
export EXPNAME="exp4_var_gt4_bs16_promptC_llama2"
torchrun --nproc_per_node 4 --master_port 11203 train_dhpr.py \
    --wandb_enable \
...
export EXPNAME="exp4_var_gt4_bs16_has_speed_llama2"
