...
export EXPNAME="exp6_var_llama2_gtn32_boxadapter_learn"
...
export EXPNAME="exp6_var_llama2_gtn32_boxadapter_learn_noindicator"
export CUDA_VISIBLE_DEVICES=0,1,2,3
torchrun --nproc_per_node 4 --master_port 13320 train_dhpr.py \
    --wandb_enable \
    --llm_model llama-2-7b \
...
export EXPNAME="exp6_var_llama2_gtn16_boxadapter_learn"
export CUDA_VISIBLE_DEVICES=0,1,2,3
torchrun --nproc_per_node 4 --master_port 13320 train_dhpr.py \
    --wandb_enable \
    --llm_model llama-2-7b \
...
export EXPNAME="exp6_var_llama2_gtn16_boxadapter_learn_noindicator"
export CUDA_VISIBLE_DEVICES=0,1,2,3
torchrun --nproc_per_node 4 --master_port 13320 train_dhpr.py \
    --wandb_enable \
    --llm_model llama-2-7b \
