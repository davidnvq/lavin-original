...
export EXPNAME="exp7_var_chat_gtn32_boxadapter_boxmodality"
...
export EXPNAME="exp7_var_chat_gtn32_boxadapter_boxmodality_noindicator"
export CUDA_VISIBLE_DEVICES=0,1,2,3
torchrun --nproc_per_node 4 --master_port 13320 train_dhpr.py \
    --wandb_enable \
    --llm_model llama-2-7b-chat \
...
export EXPNAME="exp7_var_chat_gtn16_boxadapter_boxmodality"
export CUDA_VISIBLE_DEVICES=0,1,2,3
torchrun --nproc_per_node 4 --master_port 13320 train_dhpr.py \
    --wandb_enable \
    --llm_model llama-2-7b-chat \
...
export EXPNAME="exp7_var_chat_gtn16_boxadapter_boxmodality_noindicator"
export CUDA_VISIBLE_DEVICES=0,1,2,3
torchrun --nproc_per_node 4 --master_port 13320 train_dhpr.py \
    --wandb_enable \
    --llm_model llama-2-7b-chat \
