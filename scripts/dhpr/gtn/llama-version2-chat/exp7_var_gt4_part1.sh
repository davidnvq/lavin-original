...
export EXPNAME="exp7_var_chat_gtn32_attn_has_box"
...
export EXPNAME="exp7_var_chat_gtn32_boxadapter_indicatormodality"
export CUDA_VISIBLE_DEVICES=0,1,2,3
torchrun --nproc_per_node 4 --master_port 13320 train_dhpr.py \
    --wandb_enable \
    --llm_model llama-2-7b-chat \
...
export EXPNAME="exp7_var_chat_gtn16_attn_has_box"
export CUDA_VISIBLE_DEVICES=0,1,2,3
torchrun --nproc_per_node 4 --master_port 13320 train_dhpr.py \
    --wandb_enable \
    --llm_model llama-2-7b-chat \
...
export EXPNAME="exp7_var_chat_gtn16_boxadapter_indicatormodality"
export CUDA_VISIBLE_DEVICES=0,1,2,3
torchrun --nproc_per_node 4 --master_port 13320 train_dhpr.py \
    --wandb_enable \
    --llm_model llama-2-7b-chat \
