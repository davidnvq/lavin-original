...
#$-j y
#$-o $HOME/log/$JOB_ID
#$ -N exp8_7b02_gt4_bs16-4_torch2.1
...
export EXPNAME="exp8_7b02_gt4_bs16-4_torch2.1"
export LLM=llama-2-7b
torchrun --nproc_per_node 4 --master_port 12560 train.py \
    --wandb_enable \
    --llm_model ${LLM} \
...
torchrun --nproc_per_node 1 --master_port 12563 eval.py \
